...
config_owner = [{'corporationID': 98195010}] # Format of: 'corporationID': <id> or 'allianceID': <id> (can be multiple)
config_check = '86400' # Check for the last day
config_sleep_time = 1200 # Delay between checks
config_slack_url = 'https://hooks.slack.com/services/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' # Slack integration code
